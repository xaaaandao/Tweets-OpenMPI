...
# @param palavra, que e o topico que se deseja pesquisar.
...
def allTweets(word):
	...
	for i in range(1, 17):
		for tweet in tweepy.Cursor(api.search, q=word, count=200).pages(i):
			print tweet
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 2:
		...
		print("use: python %s palavra" % sys.argv[0])